package mountainrangepvp.engine.bloom;
...
public class Bloom {
     ...
     *                    and only do blooming on certain objects
     * @param use32bitFBO does fbo use higher precision than 16bits.
     */
     ...
     * you are doing. Remember that bloom.startCapture() clear the screen so use
     ...
     */
    public void stopCaptureAndRender() {
        if (capturing) {
            capturing = false;
            frameBuffer.end();
        }

...
import mountainrangepvp.game.world.{NewMapEvent, NewSessionEvent}
...
class ProtocolTest {
  ...
  def connectionTest() = {
    ...
    eventbus.subscribeAll(recorder)
    ...
    //recorder.received(classOf[PlayerStatsUpdatedMessage])
  }

  private class EventRecorder extends EventHandler[Event] {
